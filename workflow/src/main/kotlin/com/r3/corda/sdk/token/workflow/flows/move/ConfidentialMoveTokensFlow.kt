...
// TODO can be called with either inputs-outputs or with tokenHolders-amounts/tokensToIssue
@InitiatingFlow
class ConfidentialMoveTokensFlow<T : TokenType> private constructor(
    ...
    //TODO add constructor with tokenHolders and amounts?
    ...
    override fun call(): SignedTransaction {
        ...
        //TODO we have to add sessions for all tokenHolders we anonymise
        val otherParties = partiesAndAmounts.keys + partiesAndTokens.keys
        val sessions = if (existingSessions.isEmpty()) sessionsForParticipantsAndObservers(outputs, otherParties) else existingSessions
